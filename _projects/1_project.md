...
[![Possible scores with second method](/assets/img/new_score_dist.png){: width="800"}{:style="display:block; margin-left:auto; margin-right:auto"}](/assets/img/new_score_dist.png)
...
[![Historical PMFs with and without Laplace Smoothing](/assets/img/pmf_laplace_smoothing.png){: width="800"}{:style="display:block; margin-left:auto; margin-right:auto"}](/assets/img/pmf_laplace_smoothing.png)
...
[![Simulated new method PMF vs historical](/assets/img/new_method.png){: width="800"}{:style="display:block; margin-left:auto; margin-right:auto"}](/assets/img/new_method.png)
