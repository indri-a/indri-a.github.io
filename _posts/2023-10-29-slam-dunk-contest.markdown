...
date:   2023-10-29 19:08:45 +0000
categories: fun
---

This analysis was done as a statistics class fun extra-credit project.
...
[![New scoring format](/assets/img/new_scoring_method.png){: height="200"}{:style="display:block; margin-left:auto; margin-right:auto"}](/assets/img/new_scoring_method.png)
...
[![Possible scores with first method](/assets/img/old_score_distribution.png){:style="display:block; margin-left:auto; margin-right:auto"}](/assets/img/old_score_distribution.png)
...
[![Possible scores with second method](/assets/img/new_score_dist.png){:style="display:block; margin-left:auto; margin-right:auto"}](/assets/img/new_score_dist.png)
...
[![Distribution of all scores 2000 - 2003](/assets/img/score_dist.png){:style="display:block; margin-left:auto; margin-right:auto"}](/assets/img/score_dist.png)
...
[![Historical PMFs with and without Laplace Smoothing](/assets/img/pmf_laplace_smoothing.png){:style="display:block; margin-left:auto; margin-right:auto"}](/assets/img/pmf_laplace_smoothing.png)
